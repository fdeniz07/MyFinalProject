...
namespace LinqProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            List<Category> categories = new List<Category>
           {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product{ProductId = 2,CategoryId = 1,ProductName = "Asus Laptop", QuantityPerUnit = "16 GB RAM", UnitPrice = 5000,UnitInStock = 3},
                ...
                new Product{ProductId = 5,CategoryId = 2,ProductName = "Apple Telefon", QuantityPerUnit = "8 GB RAM", UnitPrice = 9000,UnitInStock = 0}
            };
        ...
        {
            return products.Where(p => p.UnitPrice > 5000 && p.UnitInStock > 3).ToList(); //Where --> foreach'in yerini tutuyor
        }
